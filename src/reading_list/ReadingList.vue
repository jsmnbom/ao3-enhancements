...
v-app
  ...
  v-app-bar.app-bar(
    ...
    color='primary',
    dark,
    :extension-height='$vuetify.breakpoint.xsOnly ? 0 : 48',
    height='64'
  )
    v-toolbar-items
...
export default class ReadingList extends Vue {
  ...
  onToolbarIntersect([{ intersectionRatio, target }]: [
    ...
    if (intersectionRatio < 1 && this.$vuetify.breakpoint.xsOnly) {
      this.appBarOffset = 64;
    } else {
      this.appBarOffset = 0;
    }
  }
